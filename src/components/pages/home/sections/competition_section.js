...
function CompetitionSection(){
  ...
  return (
  	<IconContext.Provider value={{color:'#fff', size: 64}}>
   	...
   	<div className="competition__section" id="competition-section-id">
   		<div className="competition__wrapper">
   			<h1 className="competition__heading">COMPETITION</h1>
   			<div className="competition__container">
   				<Link to="/" className="competition__container-card">
   					<div className="competition__container-cardInfo">
                     ...
                     <p><span>* Early Bird Registration Fee: RM350</span></p>
   						<button className="competition__register-button">Register</button>
   					</div>
   				</Link>
   				<Link to="/" className="competition__container-card">
   					<div className="competition__container-cardInfo">
